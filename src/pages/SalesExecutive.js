...
const SalesExecutive = () => {
  ...
  const fetchCounts = useCallback(async () => {
    const [customerResponse, reviewResponse] = await Promise.all([
      fetch('https://prod.tophaventvs.com/sales/customers/count', {
        method: 'GET',
        headers: { accept: 'application/json', Authorization: `Bearer ${token}` }
      }),
      fetch('https://prod.tophaventvs.com/sales/customer-verification/count', {
        method: 'GET',
        headers: { accept: 'application/json', Authorization: `Bearer ${token}` }
      }),
    ]);
  ...
  const fetchCustomers = useCallback(async () => {
    const response = await fetch('https://prod.tophaventvs.com/sales/customers', {
      method: 'GET',
      headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        const response = await fetch('https://prod.tophaventvs.com/sales/create-customer', {
            method: 'POST',
            headers: {
