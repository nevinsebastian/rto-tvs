...
const CustomerForm = () => {
  ...
  useEffect(() => {
    const fetchCustomerData = async () => {
      try {
        const response = await fetch(`https://prod.tophaventvs.com/customer/customer-form/${link_token}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`https://prod.tophaventvs.com/customer/${link_token}`, {
        method: 'POST',
        body: formDataToSend,
      });
