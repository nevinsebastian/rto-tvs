...
const AccountCustomerDetails = () => {
  ...
  useEffect(() => {
    ...
    fetch(`http://65.1.180.81:8000/accounts/customers/${customerId}`, {
      headers: {
  ...
  const verifyCustomer = () => {
    fetch(`http://65.1.180.81:8000/accounts/verify/${customerId}`, {
      method: 'POST',
      headers: {
        accept: 'application/json',
        Authorization: `Bearer ${token}`,
  ...
  const handleFinanceSubmit = () => {
    ...
    fetch(`http://65.1.180.81:8000/accounts/customers/${customerId}/${financeId}`, {
      method: 'PUT',
      headers: {
        accept: 'application/json',
        Authorization: `Bearer ${token}`,
