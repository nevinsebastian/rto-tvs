...
const Admin = () => {
  ...
  const fetchBranches = async () => {
    const token = localStorage.getItem('token');
    try {
      const response = await fetch('https://prod.tophaventvs.com/admin/', {
        method: 'GET',
        headers: {
  ...
  const fetchBranchDetails = async (branchId) => {
    const token = localStorage.getItem('token');
    try {
      const response = await fetch(`https://prod.tophaventvs.com/admin/${branchId}`, {
        method: 'GET',
        headers: {
          accept: 'application/json',
          Authorization: `Bearer ${token}`,
  ...
  const fetchEmployeeData = useCallback(async () => {
    ...
    try {
      ...
      const customerResponse = await fetch('https://prod.tophaventvs.com/admin/customers', {
        method: 'GET',
        headers: {
          accept: 'application/json',
          Authorization: `Bearer ${token}`,
  ...
  const fetchCustomerData = async () => {
    ...
    for (const month of months) {
      try {
        const response = await fetch(`https://prod.tophaventvs.com/admin/monthly-customers?month=${month.month}&year=${month.year}`, {
          method: 'GET',
          headers: {
            accept: 'application/json',
            Authorization: `Bearer ${token}`,
  ...
  const handleSaveClick = async () => {
    ...
    try {
      const response = await fetch(`https://prod.tophaventvs.com/admin/${selectedBranch}`, {
        method: 'PUT',
        headers: {
          accept: 'application/json',
          'Content-Type': 'application/json',
