...
const RTODetails = () => {
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `http://65.1.180.81:8000/rto/customers/${customerId}`,
        formData,
        {
          headers: {
      ...
      if (response.status === 200) {
        ...
        const updatedCustomerResponse = await axios.get(
          `http://65.1.180.81:8000/rto/${customerId}`,
          {
            headers: {
              'Authorization': `Bearer ${token}`,
            },
  ...
  useEffect(() => {
    if (!token) {
      ...
      fetch(`http://65.1.180.81:8000/rto/${customerId}`, {
        headers: {
...
const handleDisclaimerSubmit = async () => {
  ...
  try {
    const response = await axios.post('http://65.1.180.81:8000/pdf/process_pdf/disclaimer', formData, {
      responseType: 'blob',
    });
  ...
  const handleForm21Submit = async () => {
    ...
    try {
      const response = await axios.post('http://65.1.180.81:8000/pdf/process_pdf/form21', formData, {
        responseType: 'blob',
      });
  ...
  const handleForm20Submit = async () => {
    ...
    try {
      const response = await axios.post(`http://65.1.180.81:8000/pdf/process_pdf/form20?date=${date}`, formData, {
        responseType: 'blob',
      });
  ...
  const handleInvoiceSubmit = async () => {
    ...
    try {
      const response = await axios.post('http://65.1.180.81:8000/pdf/process_pdf/invoice', formData, {
        responseType: 'blob',
      });
  ...
  const handleVerifyCustomer = async () => {
    ...
    try {
      const response = await axios.post(`http://65.1.180.81:8000/rto/verify/${customerId}`, {}, {
        headers: {
          accept: 'application/json',
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleDownloadImages = async (customerId) => {
    try {
      ...
      const customerResponse = await fetch(`http://65.1.180.81:8000/rto/${customerId}`, {
        method: 'GET',
        headers: {
          'Accept': 'application/json'
        }
      ...
      const downloadResponse = await fetch('http://65.1.180.81:8000/rto/download-images/', {
        method: 'POST',
        headers: {
